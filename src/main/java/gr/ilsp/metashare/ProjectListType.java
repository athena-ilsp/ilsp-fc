 ...
 *       &lt;sequence>
 *         &lt;element name="projectInfo" type="{http://www.ilsp.gr/META-XMLSchema}projectInfoType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProjectListType {
    ...
    protected List<ProjectInfoType> projectInfo;
     ...
     * 
     */
    public List<ProjectInfoType> getProjectInfo() {
        if (projectInfo == null) {
            projectInfo = new ArrayList<ProjectInfoType>();
        }
