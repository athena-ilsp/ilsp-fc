...
/**
 * {@link Analyzer} for Croatian.
 */
public final class CroatianAnalyzer extends StopwordAnalyzerBase {

	private static final Logger LOGGER = Logger.getLogger(CroatianAnalyzer.class);

	private final CharArraySet stemExclusionSet;

	/** File containing default Croatian stopwords. */
	public final static String DEFAULT_STOPWORD_FILE = "/stopword-lists/hrv.txt";
	 ...
	 */
	public CroatianAnalyzer(CharArraySet stopwords) {
	 ...
	 *            a stopword set
	 */
	public CroatianAnalyzer(Version matchVersion, CharArraySet stopwords) {
		this(stopwords, CharArraySet.EMPTY_SET);
	}
	 ...
	 */
	public CroatianAnalyzer(CharArraySet stopwords,	CharArraySet stemExclusionSet) {
		super( stopwords);
	...
	protected TokenStreamComponents createComponents(String fieldName) {
		...
		result = new SnowballFilter(result, new CroatianStemmer());		
