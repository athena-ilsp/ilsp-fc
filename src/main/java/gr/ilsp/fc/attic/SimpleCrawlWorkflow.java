...
import gr.ilsp.fc.attic.SimpleCrawl;
...
import gr.ilsp.fc.operations.SelectFetchedOnlyFunction;
...
public class SimpleCrawlWorkflow {
    ...
    public static Flow createFlow(Path inputDir, Path curLoopDirPath, UserAgent userAgent, FetcherPolicy fetcherPolicy,
                    BaseUrlFilter urlFilter, int maxThreads, boolean debug, String persistentDbLocation, String dbname, String[] languages,String[] langKeys, 
                    String[] classes, ArrayList<String[]> topic, double absthres, double relthres, int min_uniq_terms, int max_depth, int minTokensNumber) throws Throwable {
        ...
        //The results from the parser are forwarded to the classifier
        ...
        ClassifierPipe classifyPipe = new ClassifierPipe
        		...
        		new Classifier(langKeys,languages,classes,
        		topic, absthres, relthres, false,min_uniq_terms,
        		max_depth,minTokensNumber, _storeFilter));
