...
public class RobotRulesParser extends BaseRobotsParser {
    ...
    static {
       ...
       //FIXME    DIRECTIVE_PREFIX.put("disallow", RobotDirective.DISALLOW);
    ...
    private static RobotToken tokenize(String line) {
        for (String prefix : DIRECTIVE_PREFIX.keySet()) {
            ...
            if (line.startsWith(prefix)) {
                ...
                //FIXME if paths for "disallow" start with "*" this is not considered as wild char
                //if (dataPortion.contains("*/")){   dataPortion= dataPortion.replace("*",""); }
